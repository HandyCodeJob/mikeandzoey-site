...
"Wedding RSVP and information, demo, and practice site."
...
mikeandzoey-site relies extensively on environment settings which **will not work with Apache/mod_wsgi setups**. It has been deployed successfully with both Gunicorn/Nginx and even uWSGI/Nginx.

For configuration purposes, the following table maps the 'mikeandzoey-site' environment variables to their Django setting:
...
DJANGO_DEFAULT_FROM_EMAIL               DEFAULT_FROM_EMAIL          n/a                                            "mikeandzoey-site <noreply@mikeandzoey.com>"
DJANGO_SERVER_EMAIL                     SERVER_EMAIL                n/a                                            "mikeandzoey-site <noreply@mikeandzoey.com>"
DJANGO_EMAIL_SUBJECT_PREFIX             EMAIL_SUBJECT_PREFIX        n/a                                            "[mikeandzoey-site] "
DJANGO_ALLOWED_HOSTS                    ALLOWED_HOSTS               ['*']                                          ['mikeandzoey.com']
======================================= =========================== ============================================== ======================================================================
...
To run the tests, enter the mikeandzoey-site/tests directory and run the following commands::
...
application stacks on one host, remove the port setting entirely and add `VIRTUAL_HOST=mikeandzoey.com` to your env file.
This pass all incoming requests on `nginx-proxy` to the nginx service your application is using.

.. _nginx-proxy: https://github.com/jwilder/nginx-proxy

Postgres is saving its database files to `/data/mikeandzoey-site/postgres` by default. Change that if you wan't
...
If you are using `supervisor`, you can use this file as a starting point::
    ...
    [program:mikeandzoey-site]
    command=docker-compose up
    directory=/path/to/mikeandzoey-site
...
Place it in `/etc/supervisor/conf.d/mikeandzoey-site.conf` and run::

    supervisorctl reread
    supervisorctl start mikeandzoey-site
